...
const ScoreButtons = ({selectedCategory, setSelectedCategory, rollsRemaining, recordScore}) => {
  ...
  if (rollsRemaining < 3) {
    return (
      <div className="w-full flex gap-10 items-center justify-center">
        ...
        <DropDown selected={selectedCategory} setSelected={setSelectedCategory} options={dropOptions}/>
      </div>
    )
  }
}
