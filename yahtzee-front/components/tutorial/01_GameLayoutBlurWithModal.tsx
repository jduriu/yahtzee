...
const GameLayoutBlurWithModal = ({scorecard, setScorecard, gameFeed, setGameFeed, user}) => {
  ...
  return (
    <div className="w-full h-full relative">
      <Highlight>
        <Blur>
          <div className="absolute w-full h-full flex gap-10 p-5 border-4 border-orange-400 ">
      ...
      <div className="absolute w-full h-full top-0 left-0 flex items-center justify-center border-4 border-blue-400">
