...
from scorecards_api.schema import Scorecard, Scorecards, UpdateScorecard, Turn

scorecards_router = APIRouter(prefix="/api")
...
@scorecards_router.get("/scorecard_by_user_and_game", response_model=Scorecard)
